...
// Mağaza işletebilen roller (kendi mağazasını yönetir)
const MERCHANT_LIKE = [
  P.ADDRESS_READ,
  P.ADDRESS_WRITE,
  P.WALLET_READ,
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  CUSTOMER: [P.ADDRESS_READ, P.ADDRESS_WRITE, P.WALLET_READ, P.WALLET_TOPUP, P.STORE_READ, P.PRODUCT_READ],
  COURIER: [P.ADDRESS_READ, P.WALLET_READ],
  MERCHANT: MERCHANT_LIKE,
  RESTAURANT: MERCHANT_LIKE,
  MARKET_OPERATOR: MERCHANT_LIKE,
  COFFEE_BRANCH: [P.ADDRESS_READ, P.WALLET_READ, P.TRANSACTION_READ, P.STORE_READ, P.PRODUCT_READ, P.PRODUCT_WRITE],
